...
original_author="Miladshahhi"
original_name="miladshahhi"
original_urlname="miladshahhi"
original_description="Awesome miladshahhi created by Miladshahhi" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/miladshahhi "${name}"
...
then
    ...
    echo "then run 'miladshahhi' or 'python -m miladshahhi'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'miladshahhi' or 'python -m miladshahhi' or 'poetry run miladshahhi'"
fi
